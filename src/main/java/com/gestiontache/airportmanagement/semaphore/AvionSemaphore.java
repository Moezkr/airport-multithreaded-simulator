...
public class AvionSemaphore extends Thread {
    ...
    public AvionSemaphore(String nom, AeroportSemaphore aeroport, String etatInitial, LogListener listener) {
        super(nom);
